...
import 'package:agenda_contato_6/helpers/contact_helper.dart';
import 'package:agenda_contato_6/ui/contact_page.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return _contactsCad(context, index);
        },
      ),
    );
  }

  Widget _contactsCad(BuildContext context, int index) {
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: (contacts[index].image != null ? FileImage(File(contacts[index].image)) : AssetImage("assets/images/person.png")))
                ),
              ),
              Padding(
